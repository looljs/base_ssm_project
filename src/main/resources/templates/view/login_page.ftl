    ...
    <div id="particles-js">
        <div class="login" style="display: block;">
            ...
            <div class="login-center clearfix">
                <div class="login-center-img"><img src="../../static/login/images/name.png"></div>
            ...
            <div class="login-center clearfix">
                <div class="login-center-img"><img src="../../static/login/images/password.png"></div>
                <div class="login-center-input">
            ...
            <div class="login-center clearfix">
                <div class="login-center-img"><img src="../../static/login/images/cpacha.png"></div>
                <div class="login-center-input">
...
<script src="../../static/login/js/jquery-1.8.0.min.js"></script>
